            ...
            <div class="col-md-12">
                <div class="panel panel-white">
                    <div class="panel-heading clearfix">
                        <h4 class="panel-title">Portfolio Table</h4>
                        <h4 class="text-right"><a href="{{ url('add-portfolio') }}"><i class="icon-target">Add</i></a></h4>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody class="text-center">
                                    @foreach ($portfolio as $key=> $user)
                                        <tr>
                                            <td>{{ $key+1}}</td>
                                            <td>{{ $user->name }}</td>
                                            <td>
                                                <img style="width: 75px" src="image/{{ $user->image }}">
                                            </td>
